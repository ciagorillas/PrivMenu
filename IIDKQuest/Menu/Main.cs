...
namespace IIDKQuest.Menu
{
    ...
    ButtonCornerD
            ...
            gameObject.transform.localPosition = new Vector3(0.56f, 0.62f, 0);
            ...
            component.localPosition = new Vector3(0.064f, 0.187f, 0f);
            component.rotation = Quaternion.Euler(new Vector3(180f, 90f, 90f));
            ...
            nextPageButton.transform.localPosition = new Vector3(0.56f, -0.62f, 0);
            ...
            component.localPosition = Vector3.zero;
            component.sizeDelta = new Vector2(0.2f, 0.03f);
            component.localPosition = new Vector3(0.064f, -0.188f, 0f);
            component.rotation = Quaternion.Euler(new Vector3(180f, 90f, 90f));
